...
class PlacesViewController: UIViewController, ShowAlert {
    ...
    func placesWebService(searchType: String) {
        ...
        let urlString = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=\(latitude),\(longitude)&radius=5000&type=\(searchType)&key=AIzaSyCaSjiwkdmPQrKdhRCSWWJXFAq9gbFPuik"
    ...
    func getNearByPlacesWithText(searchText: String) {
        ...
        let urlString :String  = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=\(searchText)&key=AIzaSyCaSjiwkdmPQrKdhRCSWWJXFAq9gbFPuik"
        print(urlString)
...
extension PlacesViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // print(dict_Obj)
        if let image = dict_Obj["icon"] as? String {
            cell.imageView_icon.sd_setImage(with: URL(string: image))
        }
